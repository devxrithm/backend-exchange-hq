...
import { userLogin, userSignup, userLogout, genrateNewAccessAndRefreshToken } from "./AuthControllers";
...
AuthRouter.post("/auth/new-refresh-token", verifyJWT, genrateNewAccessAndRefreshToken);
